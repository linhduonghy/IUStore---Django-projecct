# Generated by Django 3.2.3 on 2021-06-05 06:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('created_date', models.DateTimeField(blank=True, db_column='Created_date', default=datetime.datetime.now)),
                ('statusNow', models.CharField(blank=True, db_column='Status_now', max_length=255, null=True)),
                ...
                ('deliveryAddress', models.ForeignKey(blank=True, db_column='DeliveryAddressID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='mystore.deliveryaddress')),
            ],
            options={
                'db_table': 'order',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('shipmentMethod', models.ForeignKey(db_column='ShipmentMethodID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='mystore.shipmentmethod')),
                ('shipper', models.ForeignKey(blank=True, db_column='ShipperID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='mystore.shipper')),
            ],
            options={
                'db_table': 'shipment',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('paymentDetail', models.ForeignKey(blank=True, db_column='PaymentDetailID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='mystore.paymentdetail')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(db_column='MemberID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='mystore.member')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('content', models.CharField(blank=True, db_column='content', max_length=255, null=True)),
                ('time', models.DateTimeField(blank=True, db_column='time', default=datetime.datetime.now, null=True)),
                ('attach', models.CharField(blank=True, db_column='attach', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(blank=True, db_column='Created_date', default=datetime.datetime.now)),
                ('comment', models.ForeignKey(db_column='CommentID', on_delete=django.db.models.deletion.DO_NOTHING, to='mystore.comment')),
                ('customer', models.ForeignKey(blank=True, db_column='CustomerID', null=True, on_delete=django.db.models.deletion.CASCADE, to='mystore.customer')),
